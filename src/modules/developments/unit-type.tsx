...
import { useUnitTypeList } from '@/services/unit-type'
import { UnitTypeDialogForm } from '@/components/dialog/unit-type-dialog-form'
import { getStatusMeta } from '@/utils/status'

type Row = { id: string; token: number; name: string; status: boolean }

export const ModuleUnitType = ({ title }: { title: string }) => {
  const entity = 'tipo de unidade'
  ...
  const [selectedUnitType, setSelectedUnitType] = React.useState<ApiUnitType | undefined>(undefined)
  ...
  return (
    <>
      <PageHeader title={title} subtitle="Listagem de tipos de unidade registrados" backButton />
